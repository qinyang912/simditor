(function() {
  $(function() {
    ...
    toolbar = ['title', 'undo', 'redo', 'formatPaint', 'clear-format', 'bold', 'italic', 'underline', 'strikethrough', 'font-family', 'fontScale', 'color', 'background', 'time-stamp', 'line-height', '|', 'ol', 'ul', 'blockquote', 'code', 'table', '|', 'link', 'image', 'attach', 'hr', '|', 'indent', 'outdent', 'alignment'];
