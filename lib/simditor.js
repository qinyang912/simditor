...
Formatter = (function(superClass) {
  ...
  Formatter.prototype._init = function() {
    ...
    this._allowedAttributes = $.extend({
      ...
      code: ['class'],
      p: ['class', 'data-unique-id', 'data-file-id', 'data-file-name', 'data-file-src', 'data-attach', 'data-img', 'data-global-link', 'data-setting', 'data-task-block', 'data-map'],
      span: ['class', 'contenteditable', 'data-name', 'data-size', 'href', 'data-bucket', 'data-osskey', 'data-key-name', 'title', 'data-global-link-type', 'data-title', 'data-sub-title', 'data-attach-type'],
