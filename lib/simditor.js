...
OrderListButton = (function(superClass) {
  ...
  OrderListButton.prototype.shortcut = 'ctrl+alt+o';

  OrderListButton.prototype._init = function() {
    this.title = this.title + ' ( Ctrl + Alt + O )';
...
UnorderListButton = (function(superClass) {
  ...
  UnorderListButton.prototype.shortcut = 'ctrl+alt+u';

  UnorderListButton.prototype._init = function() {
    this.title = this.title + ' ( Ctrl + Alt + U )';
